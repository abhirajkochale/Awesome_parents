...
import { Send, MessageSquare, ClipboardList, Paperclip, CornerDownRight, Clock, Loader2 } from 'lucide-react';
        ...
        >
            ...
            <motion.div variants={itemVariants} className="mb-12">
                ...
                <p className="text-lg text-slate-500 font-medium mt-4 max-w-2xl font-['Be_Vietnam_Pro']">
                    Have a question or need assistance? Our dedicated support team is here to help you navigate your journey at AwesomeKids.
                </p>
            </motion.div>

            <div className="grid grid-cols-12 gap-8 items-start">
                
                {/* Section 1: Raise a Query (The Action Hub) */}
                <motion.div variants={itemVariants} className="col-span-12 lg:col-span-5">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center gap-4">
                                            <Button
                                                ...
                                                className="bg-slate-50 hover:bg-white border-dashed border-2 border-slate-200 text-slate-500 rounded-2xl h-14 px-6 flex-1 justify-start gap-3 transition-all group/btn"
                                            >
                    ...
                    {/* Quick Contact Card */}
                    <div className="mt-8 bg-[#fff8f0] rounded-[40px] p-8 flex items-center gap-6 relative overflow-hidden group">
                         <div className="p-4 bg-white rounded-3xl shadow-sm shadow-orange-100 text-orange-600">
                ...
                {/* Section 2: Recent Queries (The History Feed) */}
                                            ...
                                            >
                                                <div className="flex justify-between items-start mb-6">
                                                    <div className="space-y-1">
                                                        ...
                                                        <p className="text-[10px] font-bold text-slate-300 tracking-wider">TICKET #{query.id.split('-')[0].toUpperCase()}</p>
                                                    </div>
                                                    <span className={cn(
                                                ...
                                                <AnimatePresence>
                                                    {query.admin_reply && (
                                                        <motion.div 
                                                            ...
                                                            className="relative mt-8 group/reply"
                                                        >
